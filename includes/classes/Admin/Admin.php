    ...
    public function handle_form_submission() {
        ...
        if (isset($_POST['add_publicatie'])) {
            ...
            $data = [
                ...
                'coverimage_urls' => array_map('esc_url_raw', $_POST['coverimage_urls']),
            ...
            // Deze functionaliteit moet worden geïmplementeerd
            // Bijvoorbeeld:
            // $this->db->insert_publicatie(new Publicatie($data));
