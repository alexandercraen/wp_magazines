...
class Publicatie {
    ...
    public function __construct($data = []) {
        ...
        $this->flipboek_id = isset($data['flipboek_id']) ? intval($data['flipboek_id']) : 0;
        ...
        $this->formaat = isset($data['formaat']) ? sanitize_text_field($data['formaat']) : '';
        $this->weergave_opties = isset($data['weergave_opties']) ? sanitize_text_field($data['weergave_opties']) : '';
        $this->tekst = isset($data['tekst']) ? sanitize_text_field($data['tekst']) : '';
